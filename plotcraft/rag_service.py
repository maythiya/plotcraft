...
class RAGService:
    ...
    def chat_with_editor(self, user_query, novel_id=None, user_id=None):
        ...
        2. อย่าแค่ตอบรับเฉย ๆ ให้ "เสนอไอเดียเพิ่ม" หรือ "ชวนคิดในอีกมุม" เสมอ
        3. ถ้า Context มีข้อมูลตัวละคร ให้ยกชื่อตัวละครมาพูดถึงเพื่อให้รู้ว่าพี่อ่านอยู่จริง

        Format (รูปแบบการตอบ):
        - Tone: ภาษาพูด เหมือนพิมพ์แชทไลน์ (แทนตัวว่า "พี่" แทน User ว่า "เรา/น้อง")
        - ถ้าคุยเล่น: เป็นการตอบสั้น ๆ ประมาณ 1-3 บรรทัด พูดคุยเรื่องเทคนิคการเขียนทั่วไป
        - ถ้าถามงาน/ปรึกษาพล็อต: ตอบบรรยายแบบยาวได้ตามความเหมาะสม แต่ให้เว้นบรรทัดบ่อย ๆ ให้อ่านง่าย และไม่รกตาจนเกินไป
        - Style: ห้ามใช้ Markdown หัวข้อใหญ่ ๆ อย่างเช่น #, *, - ในการจัดรูปแบบเด็ดขาด! ถ้าต้องการขึ้นบรรทัดใหม่ให้ใช้การเว้นบรรทัดธรรมดา และถ้าต้องการแบ่งหัวข้อย่อยให้ใช้รูปแบบปกติ เช่น "ชื่อหัวข้อ: คำอธิบาย"
    ...
    def generate_item_data(self, concept):
        ...
        try:
            ...
            5. [สำคัญมาก] ห้ามใส่ HTML Tags (เช่น <ul>, <li>, <b>, <p>) มาในข้อความเด็ดขาด!
               - หากต้องการขึ้นบรรทัดใหม่ให้ใช้เครื่องหมาย \\n 
               - หากต้องการแบ่งหัวข้อย่อยให้ใช้รูปแบบปกติ เช่น "- ชื่อความสามารถ: คำอธิบาย"
            6. ตอบกลับเป็น JSON Format เท่านั้น โดยใช้ Key ตามนี้:
            {{
                "name": "ชื่อไอเทม",
                "abilities": "ความสามารถพิเศษ หรือผลของไอเทม (แยกหัวข้อด้วยการขึ้นบรรทัดใหม่ \\n และใช้เครื่องหมาย - )",
