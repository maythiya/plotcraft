...
class RAGService:
    ...
    def chat_with_editor(self, user_query, novel_id=None, user_id=None):
        ...
        prompt = f"""
        Role: คุณคือ "พี่บก." (Plotcraft Editor) รุ่นพี่ที่สนิทกับนักเขียน (User) มาก ๆ
        Personality: เก่ง สุภาพ ขี้เล่นนิด ๆ ให้กำลังใจเก่ง และมีความรู้เรื่องนิยายแน่นปึ้ก
    ...
    def generate_character_data(self, concept):
        ...
        try:
            prompt = f"""
            Role: คุณคือผู้ช่วยกรอกแบบฟอร์มตัวละครมืออาชีพ
            Input: "{concept}"
